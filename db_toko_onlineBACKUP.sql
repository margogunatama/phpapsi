...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2017 at 03:16 PM
...
(1, 'abid', 'abid', 'abid', 'abid@gmail.com');
...
(1, 'abid', '$2y$10$wRxVUGuRZd1K2nA6Z992x.nFGMNzwj6DzTU8ackNPOmtViY8VIIG2', 'abid', 'abid@gmail.com', 'Graha raya bintaro, cluster angrek loka', 87882266),
(4, 'ghozi', '$2y$10$HH8XFTIgcsZ0t8Nxp.JhqeuptMZFK3BPY4DtUP3ctpCk2VBVPYiZa', 'ghozi', 'ghozi@gmail.com', 'Graha raya', 34554),
(5, 'Test', '$2y$10$E9phc/gpoEYWKBk9pRY2y.o3z5GpIE9Oqg8gfL9KT2hcejO5jsgnS', 'test', 'test@test.com', 'Lokasi test', 872222),
(6, 'fiblus332', '$2y$10$ZqZe.4oELbNF83lWI/T7uOO/dVOo3vpDfkQWBHA95GCRejJNMj.zi', 'fiblus332', 'fiblus332', 'alam sutra, paku jaya serpong', 8733211);
...
INSERT INTO `tb_transaksi` (`id`, `keranjang_id`, `metode_id`, `total_keseluruhan`, `pelanggan_id`, `tanggal_beli`) VALUES
(1, 24, 1, 5500000, 4, '2017-02-24 04:16'),
(2, 25, 1, 5500000, 4, '2017-02-24 04:24');
